...
set.seed(1)
divisao <- sample.split(base_censo$income, SplitRatio = 0.85) #5% da base para aprendizagem, pois algoritmo lento
...
#  0    1  -> 3398/(3398+1126) = 75,11% VALOR MÍNIMO DE ACERTO EM QUALQUER ALGORITMO DE PREVISÃO
#3398 1126 -> Pois, se Prob < 75%, usar Base Line classifier!!
#Funciona tb como primeira conferência da precisão do algoritmo 
