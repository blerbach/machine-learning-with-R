...
#instalando pacote com funções para Ramdom Forest#
#install.packages("randomForest") 
library("randomForest")

#Criando classificador#
classificador <- randomForest(x = base_treinamento[-15], y = base_treinamento$income, ntree = 100) # x = Vars históricas, y = classe e ntree = N° de árvores
print(classificador)
