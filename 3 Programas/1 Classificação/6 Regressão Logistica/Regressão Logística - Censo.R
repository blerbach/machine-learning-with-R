...
set.seed(1)
divisao <- sample.split(base_censo$income, SplitRatio = 0.5) #75% da base para aprendizagem
...
#Categorizando dados por intervalo de probabilidades#
previsao <- ifelse(probabilidades < 0.5,0,1)
