...
# Retornando Probabilidade da classificação estar correta
probrf = predict(rfFinal, newdata = base_credit[4,-4], type = "prob")
#Pegando o valor de maior probabilidade
confiancarf = max(probrf)

probrna = predict(rnaFinal, newdata = as.h2o(base_credit[4,-4]))
